...
class EcrtokenType:
    """
    :ivar signing_author: ECR id: Αριθμός μητρώου του φορολογικού
        μηχανισμού
    :ivar session_number: Μοναδικός 6-ψήφιος κωδικός που χαρακτηρίζει
        την κάθε συναλλαγή
    """
...
class ProviderSignatureType:
    """
    :ivar signing_author: Provider’s Id
    :ivar signature: Υπογραφή
    """
...
class OtherDeliveryNoteHeaderType:
    """
    :ivar loading_address: Διεύθυνση Φόρτωσης
    :ivar delivery_address: Διεύθυνση Παράδοσης
    :ivar start_shipping_branch: Εγκατάσταση έναρξης διακίνησης (Εκδότη)
    :ivar complete_shipping_branch: Εγκατάσταση ολοκλήρωσης διακίνησης
        (Λήπτη)
    """
...
class PaymentMethodDetailType:
    ...
    :ivar tip_amount: Φιλοδώρημα
    :ivar transaction_id: Μοναδική Ταυτότητα Πληρωμής
    :ivar providers_signature: Υπογραφή Πληρωμής Παρόχου
    :ivar ecrtoken: Υπογραφή Πληρωμής ΦΗΜ με σύστημα λογισμικού (ERP)
    """
...
class ResponseType:
    ...
    :ivar payment_method_mark: Μοναδικός Αριθμός Παραλαβής Τρόπου
        Πληρωμής
...
class InvoiceRowType:
    ...
    :ivar taric_no: Κωδικός Taric
    :ivar item_code: Κωδικός Είδους
    ...
    :ivar other_measurement_unit_quantity: Πλήθος Μονάδας Μέτρησης
        Τεμάχια Άλλα
    :ivar other_measurement_unit_title: Τίτλος Μονάδας Μέτρησης Τεμάχια
        Άλλα
    """
...
class PaymentMethodType:
    """
    :ivar invoice_mark: Μοναδικός Αριθμός Καταχώρησης Παραστατικού
    :ivar payment_method_mark: Αποδεικτικό Λήψης Τρόπων Πληρωμής.
        Συμπληρώνεται από την Υπηρεσία
    :ivar entity_vat_number: ΑΦΜ Οντότητας Αναφοράς
    :ivar payment_method_details:
    """
...
class InvoiceHeaderType:
    ...
    :ivar other_delivery_note_header: Λοιπά Γενικά Στοιχεία Διακίνησης
    :ivar is_delivery_note: Ένδειξη Παραστατικού Διακίνησης
    :ivar other_move_purpose_title: Τίτλος της Λοιπής Αιτίας Διακίνησης
    :ivar third_party_collection: Ένδειξη Εισπράξης Τρίτων
    """
